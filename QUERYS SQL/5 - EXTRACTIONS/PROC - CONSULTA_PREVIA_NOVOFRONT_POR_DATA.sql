...
CREATE PROCEDURE CONSULTAS_PREVIAS_NOVOFRONT 
	...
	(
		...
		WHERE DESCRICAO_PARCEIRO = ''LASA''
			...
			OR DESCRICAO_PARCEIRO = ''ANGELONI''
		GROUP BY 
		DESCRICAO_PARCEIRO,
		DATA_VENDA
			...
			PIVOT
			(
				SUM(QTDE_CONSULTA_PREVIA) FOR DATA_VENDA IN ('+@COLUNAS+')
			) AS PIVOTTABLE;'
...
EXEC CONSULTAS_PREVIAS_NOVOFRONT 7 -- INFORME O MÊS 