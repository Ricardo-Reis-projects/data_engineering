...
FROM TB_AUDIT 
WHERE DT_B1_CONTA > CONVERT(DATE,DATEADD(MONTH,-6, GETDATE())) AND DT_B1_CONTA < CONVERT(DATE,GETDATE()) 
...
SELECT 
	...
	COUNT(CONTA) QTD_CONTA
FROM TB_AUDIT 
WHERE DT_B1_CONTA >= CONVERT(DATE,DATEADD(YEAR,-1, GETDATE())) AND DT_B1_CONTA <= CONVERT(DATE,DATEADD(MONTH,-6, GETDATE())) 
GROUP BY ST_CONTA,CONTA_2,B2_CONTA
...
SELECT 
	...
	COUNT(CONTA) QTD_CONTA
FROM TB_AUDIT 
WHERE DT_B1_CONTA >= CONVERT(DATE,DATEADD(YEAR,-2, GETDATE())) AND DT_B1_CONTA < CONVERT(DATE,DATEADD(YEAR,-1, GETDATE())) 
GROUP BY ST_CONTA,CONTA_2,B2_CONTA
...
SELECT 
	...
	COUNT(CONTA) QTD_CONTA
FROM TB_AUDIT 
WHERE DT_B1_CONTA >= CONVERT(DATE,DATEADD(YEAR,-3, GETDATE())) AND DT_B1_CONTA < CONVERT(DATE,DATEADD(YEAR,-2, GETDATE()))
GROUP BY ST_CONTA,CONTA_2,B2_CONTA
...
SELECT 
	...
	COUNT(CONTA) QTD_CONTA
FROM TB_AUDIT 
WHERE DT_B1_CONTA < CONVERT(DATE,DATEADD(YEAR,-3, GETDATE()))
GROUP BY ST_CONTA,CONTA_2,B2_CONTA

------------------------------------------------QUANTIDADE DE CONTAS BLOQUEDAS POR PERIODO-------------------------------------------------
