	DELETE FROM [DB_SAMSUNG].[dbo].[TB_SAMSUMG_SAP_RMA_FOLLOW] WHERE DT_DATA_BASE IN (SELECT CONVERT(DATE, [DT_BASE], 103) FROM [DB_SAMSUNG].[dbo].st_RMA_BASE)
	...
	SELECT [Company]								AS NM_COMPANY
		  ...
		  ,TRY_CONVERT(DATE, [HC Date], 103)		AS NM_HC_DATE 
		  ...
		  ,TRY_CONVERT(DATE, [Previous Date3], 103)	AS NM_PREVIOUS_3_DATE 
