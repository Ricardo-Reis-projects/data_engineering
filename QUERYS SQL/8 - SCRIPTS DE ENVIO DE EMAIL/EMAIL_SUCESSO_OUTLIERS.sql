...
-- Assunto do Email
SET @subjectText = 'Validador Outliers - Marcação NBA Oi Retenção Fixo e Velox'
-- Titulo do Corpo do Email
SET @subjectBody = 'Report Validador Outliers: Marcação NBA Oi Retenção Fixo e Velox'
-- Mensagem do Corpo do email - LINHA 1
SET @messageBodyRow1 = 'Marcação NBA Oi Retenção Fixo e Velox: '
-- Mensagem do Corpo do email - LINHA 2 
SET @messageBodyRow2 = ''
-- Mensagem do Corpo do email - LINHA 3
SET @messageBodyRow3 = 'Operações: Retenção Fixo e Velox | Retenção Lojas Fixo e Velox'
...
+ '<table>'
+ '<thead>'
+ '<tr><th>OPERAÇÃO<th>DATA<th>CHAMADAS ATENDIDAS<th>MARCAÇÕES<th>% DE MARCAÇÃO</tr>'
+ '</thead>'
-- CONVERSAO PARA XML
